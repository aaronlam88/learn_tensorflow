...
if __name__ == "__main__":
    ...
    parser.add_argument("--start_time", help="Start date in the format YYYY-MM-DD (default: 1 year ago)")
    parser.add_argument("--end_time", help="End date in the format YYYY-MM-DD (default: today)")
    ...
    symbol_retrieval.main(args.start_time, args.end_time)
